...
//! to select the page.
//#![expect(dead_code, reason = "Register definitions kept for completeness; not
//#![expect(dead_code, all are used at runtime")]
...
// ---------------------------------------------------------------------------
// Function page (PAGE_FUNCTION = 0x03) register addresses and values
// ---------------------------------------------------------------------------
